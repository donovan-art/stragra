/**
 * Master Plan Schema - Client #001 (Stragra)
 * 
 * This schema defines the complete onboarding structure for AI agency setup.
...
export const Phase1LegalSchema = z.object({
  // LLC Information (California specific)
...
// ============================================================================
// Phase 3: Departments / Operations
// ============================================================================
...
export const MilestoneSchema = z.object({
  ...
  targetDate: z.string().datetime().optional(), // ISO date
  status: MilestoneStatusSchema.default("not_started"),
  owner: z.string().optional(), // Department or person
  dependencies: z.array(z.string()).default([]), // IDs of blocking milestones
...
/**
 * Checks if all required Phase 1 fields are complete
 */
export function isPhase1Complete(plan: MasterPlan): boolean {
...
/**
 * Gets a human-readable summary of Phase 1 completion
 */
export function getPhase1CompletionSummary(plan: MasterPlan): {
  complete: boolean;
  percentage: number;
  missing: string[];
} {
...
/**
 * Validates the entire master plan
 */
export function validateMasterPlan(data: unknown): {
  success: boolean;
  data?: MasterPlan;
  errors?: z.ZodError;
} {
