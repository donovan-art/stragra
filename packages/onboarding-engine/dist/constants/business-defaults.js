...
export function getShadowValue(userValue, defaultValue) {
    return userValue ?? defaultValue;
}
export function mergeWithDefaults(userConfig, defaults) {
    return {
        ...defaults,
        ...Object.fromEntries(Object.entries(userConfig).filter(([, v]) => v !== undefined && v !== null)),
    };
}
//# sourceMappingURL=business-defaults.js.map